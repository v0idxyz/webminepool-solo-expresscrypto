...
class WMP {
    ...
    public function users($threshold=0){
        return $this->run("/users/$threshold");
    }
    
    public function user($username){
        return $this->run("/user/$username");
    }
    ...
    public function reset_all_user_hashes($threshold = 0){
        return $this->run("/reset_all_user_hashes/$threshold");
    }
